...
import { P as PhysicalDPSGemOptimizer } from "./suggest_gems_action-028be518.chunk.js";
import { s as standardCooldownDefaults } from "./apl_utils-719a0663.chunk.js";
...
const BearWeaveActive = makeSpecOptionsBooleanInput({
  ...
  label: "Enables Bearweaving",
  labelTooltip: "Enables Bearweaving rotation.",
  extraCssClasses: ["within-raid-sim-hide"]
});
const SnekWeaveActive = makeSpecOptionsBooleanInput({
  fieldName: "snekWeaveActive",
  label: "Enables Snakeweaving",
  labelTooltip: "Enables Snake/Idol/weapon weaving into the bearweaving rotation.",
  extraCssClasses: ["within-raid-sim-hide"]
});
...
//# sourceMappingURL=sim-1a73da2e.chunk.js.map
